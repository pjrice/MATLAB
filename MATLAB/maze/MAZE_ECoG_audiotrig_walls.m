...
imgbasepath = 'Z:\Work\UW\projects\MAZE\assets\arrows\';
...
dstRect = [0 0 s1 s2];
updstRect = CenterRectOnPointd(dstRect, xCenter, yCenter*1.6);
leftdstRect = CenterRectOnPointd(dstRect, xCenter*0.7, yCenter*1.8);
rightdstRect = CenterRectOnPointd(dstRect, xCenter*1.3, yCenter*1.8);
...
soundstamps = nan(numtrials,4,numblocks); %|trial start|disp of "Enter"|resp to enter|trial stop|
stepper_ts = cell(numtrials,100,2,numblocks); %third dimension: 1st: display of just entered room; 2nd: resp to proceed
stepper_ss = cell(numtrials,100,2,numblocks); %third dimension: 1st: display of just entered room; 2nd: resp to proceed
...
%                     progression(trial,stepper,block) = roomnum;
                    ...
                    stepper_ss{trial,stepper,1,block} = PsychPortAudio('Start', pahandle, reps, 0, 1);
                    PsychPortAudio('Stop', pahandle);
                    ...
                    while respToBeMade == true && spTimeFramescheck < spTimeFrames
                        ...
                        elseif keyCode(lKey)
                            ...
                            stepper_ss{trial,stepper,2,block} = PsychPortAudio('Start', pahandle, reps, 0, 1);
                            PsychPortAudio('Stop', pahandle);
                            respToBeMade = false;
                            switch facing
                                case 'left'
