%test streaming of what I think are the differential channels
...
try
    ...
    %Configure channels 1,3 as analog, rest as digital.  That means we
    %will start from channel 0 and update all 16 flexible bits.  We will
    %pass a value of b0000000000000101.
    ...
    %function overload.
    ljudObj.ePut(ljhandle, LabJack.LabJackUD.IO.PUT_ANALOG_ENABLE_PORT, 0, 9, int32(16));
...
ljudObj.AddRequest(ljhandle, LabJack.LabJackUD.IO.ADD_STREAM_CHANNEL_DIFF, 0, 0, 3, 0);
