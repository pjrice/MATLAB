...
fingerchooser = symfinchooser(s_index(:,1));  %THIS IS SO FUCKED BUT A QUICK FIX FOR TESTING AT HOME WITH UPDATED SHUFFLE
%SERIOUSLY DON'T YOU DARE RUN THIS IN FRONT OF A PATIENT
