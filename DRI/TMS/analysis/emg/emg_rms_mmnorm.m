...
for b = 1:4
    ...
    for t = 1:length(emg_mmnorm)
        ...
        rule_emg{t,b,1} = emg_mmnorm{t,b,1}(ts_frames(t,4,b):ts_frames(t,6,b)-rtrim);
        rule_emg{t,b,2} = emg_mmnorm{t,b,2}(ts_frames(t,4,b):ts_frames(t,6,b)-rtrim);
        
        delay_emg{t,b,1} = emg_mmnorm{t,b,1}(ts_frames(t,6,b):ts_frames(t,8,b)-dtrim);
        delay_emg{t,b,2} = emg_mmnorm{t,b,2}(ts_frames(t,6,b):ts_frames(t,8,b)-dtrim);
        
        resp_emg{t,b,1} = emg_mmnorm{t,b,1}(ts_frames(t,9,b)-750:ts_frames(t,9,b)+750);
        resp_emg{t,b,2} = emg_mmnorm{t,b,2}(ts_frames(t,9,b)-750:ts_frames(t,9,b)+750);
...
for b = 1:4
    ...
    for t = 1:length(cat(1,es_index{:,b}))
        ...
        es_emg{t,b,1} = emg_mmnorm{es_indices(t),b,1}(ts_frames(es_indices(t),3,b)-1500:ts_frames(es_indices(t),3,b)+1500);
        es_emg{t,b,2} = emg_mmnorm{es_indices(t),b,2}(ts_frames(es_indices(t),3,b)-1500:ts_frames(es_indices(t),3,b)+1500);
        
        ls_emg{t,b,1} = emg_mmnorm{ls_indices(t),b,1}(ts_frames(ls_indices(t),7,b)-1500:ts_frames(ls_indices(t),7,b)+1500);
        ls_emg{t,b,2} = emg_mmnorm{ls_indices(t),b,2}(ts_frames(ls_indices(t),7,b)-1500:ts_frames(ls_indices(t),7,b)+1500);
...
for b = 1:4
    ...
    for t = 1:length(emg_mmnorm)
        ...
        emg_rms{t,b}(1,:) = winrms(emg_mmnorm{t,b,1},windowlength,overlap,0);
        emg_rms{t,b}(2,:) = winrms(emg_mmnorm{t,b,2},windowlength,overlap,0);
